...
import DetalhesNomeado from './detalhesNomeado';
  ...
  return (
    <>
      ...
      <div style={{
        ...
        padding: '8px 16px',
        borderRadius: '24px',
        background: perfil.status === 'Ativo' ? 'rgba(44, 220, 31, 0.2)' : 'rgba(100, 100, 100, 0.2)',
        color: perfil.status === 'Ativo' ? '#21ac42cb' : '#999999',
        fontSize: '0.85rem',
        fontWeight: '600',
        border: `1px solid ${perfil.status === 'Ativo' ? '#0fc424ad' : '#666666'}`,
        textTransform: 'uppercase',
        letterSpacing: '1px'
      }}>
        ● {perfil.status}
